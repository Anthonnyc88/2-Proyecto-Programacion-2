 ...
 * @author Anthonny
 */
public class eliminar_Oficinas extends javax.swing.JFrame {
     ...
     public void Cargar_tabla_eliminar() {
       ...
       // crearConexionGeneralEliminarRoger();
        try {
            ...
            rs = s.executeQuery("SELECT id_oficina, nombre_oficina FROM oficinas ORDER BY nombre_oficina ASC");
            
            while (rs.next()) {
                id_marca.add(rs.getString("id_oficina"));
                marca.add(rs.getString("nombre_oficina"));
                ...
                if (opcion == 0) {
                   crearConexionGeneralEliminarAnthonny();
                    ...
                    try {
                        ...
                        s = connection.createStatement();
                        int z = s.executeUpdate("DELETE FROM oficinas WHERE id_oficina = '" + strResultado + "'");
                        if (z == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eliminar_Oficinas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminar_Oficinas().setVisible(true);
            }
        });
    }

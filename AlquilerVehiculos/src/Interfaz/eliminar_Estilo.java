 ...
 * @author Anthonny
 */
public class eliminar_Estilo extends javax.swing.JFrame {
    ...
    public void crearConexionGeneralEliminar() {
     ...
     public void Cargar_tablaeliminar() {
        ...
        try {
            ...
            rs = s.executeQuery("SELECT id_estilo, nombre_estilo FROM estilo ORDER BY nombre_estilo ASC");
            
            while (rs.next()) {
                id_marca.add(rs.getString("id_estilo"));
                marca.add(rs.getString("nombre_estilo"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminar_Estilo().setVisible(true);
            }
        });
    }

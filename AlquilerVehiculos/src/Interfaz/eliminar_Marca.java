 ...
 * @author Anthonny
 */
public class eliminar_Marca extends javax.swing.JFrame {
    ...
    public void crearConexionGeneralEliminarRoger() {
     ...
     public void Cargar_tabla_eliminar() {
        ...
        try {
            ...
            rs = s.executeQuery("SELECT id_marca, nombre_marca FROM marca ORDER BY nombre_marca ASC");
            
            while (rs.next()) {
                id_marca.add(rs.getString("id_marca"));
                marca.add(rs.getString("nombre_marca"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminar_Marca().setVisible(true);
            }
        });
    }
